...
class Hub_Templates_Lib {
	 ...
	 * @var string API URL.
	 */
	public static $api_url = 'http://staging.liquid-themes.com/aihubcollection/wp-json/HubCollections/v1/templates';
	...
	public static function enqueue_editor_scripts() {
		wp_enqueue_script(
			'hub-templates-lib',
			plugin_dir_url( __FILE__ ) . '/template-library.min.js',
			[
				'jquery',
				'backbone-marionette',
				'backbone-radio',
		...
		wp_localize_script( 'hub-templates-lib', 'hub_templates_lib', array(
			'logoUrl'	=> LQD_CORE_URL . 'assets/img/logo/liquid-logo.svg',
		) );
	}
	...
	private static function get_templates_data( $force_update = false ) {
		$cache_key = 'hub_templates_data_' . LQD_CORE_VERSION;
	...
	public static function get_template_content( $template_id ) {
		...
		if ( 'valid' != get_option( 'aihub_purchase_code_status', false ) ) {
			return new \WP_Error( 'no_license', esc_html__( 'Please Active The AIHub Theme') );
		}
	...
	public static function render_template() {
		...
		<script type="text/template" id="tmpl-elementor-template-library-header-actions-hub">
			<div id="elementor-template-library-header-sync" class="elementor-templates-modal__header__item">
				<i class="eicon-sync" aria-hidden="true" title="<?php esc_attr_e( 'Sync Templates', 'aihub-core' ); ?>"></i>
				<span class="elementor-screen-only"><?php echo esc_html__( 'Sync Templates', 'aihub-core' ); ?></span>
			</div>
		</script>
		<script type="text/template" id="tmpl-elementor-templates-modal__header__logo_hub">
			<span class="elementor-templates-modal__header__logo__icon-wrapper">
				<img src="<?php echo esc_url( LQD_CORE_URL . 'assets/img/logo/liquid-logo.svg' ); ?>" style="height: 30px;" />
			</span>
		...
		<script type="text/template" id="tmpl-elementor-template-library-templates-hub">
					...
					<div id="elementor-template-library-filter-toolbar-remote" class="elementor-template-library-filter-toolbar">
						<# if ( 'new_page' === activeType ) { #>
							<div id="elementor-template-library-order">
								...
								<label for="elementor-template-library-order-new" class="elementor-template-library-order-label"><?php echo esc_html__( 'New', 'aihub-core' ); ?></label>
								...
								<label for="elementor-template-library-order-trend" class="elementor-template-library-order-label"><?php echo esc_html__( 'Trend', 'aihub-core' ); ?></label>
								...
								<label for="elementor-template-library-order-popular" class="elementor-template-library-order-label"><?php echo esc_html__( 'Popular', 'aihub-core' ); ?></label>
							</div>
						<# } else {
						...
						<div id="elementor-template-library-my-favorites">
							...
							<label id="elementor-template-library-filter-my-favorites-label" for="elementor-template-library-filter-my-favorites">
								...
								<?php echo esc_html__( 'My Favorites', 'aihub-core' ); ?>
							</label>
						</div>
						<div class="elementor-template-library-expanded-template-alert">
							...
							<div>Some templates (tabs and carousels) might require additional templates. <a href="<?php echo esc_url('https://docs.liquid-themes.com/article/594-ai-hub-ai-hub-collections'); ?>" target="_blank">More info ></a></div>
						</div>
					</div>
				<# } #>
				<div id="elementor-template-library-filter-text-wrapper">
					<label for="elementor-template-library-filter-text" class="elementor-screen-only"><?php echo esc_html__( 'Search Templates:', 'aihub-core' ); ?></label>
					<input id="elementor-template-library-filter-text" placeholder="<?php echo esc_attr__( 'Search', 'aihub-core' ); ?>">
			...
			<# if ( 'hub_collections' === activeSource ) { #>
				<div id="elementor-template-library-footer-banner">
					...
					<div class="elementor-excerpt"><?php echo esc_html__( 'Stay tuned! More awesome templates coming real soon.', 'aihub-core' ); ?></div>
				</div>
			<# } #>
		</script>
			...
			<div class="elementor-template-library-template-footer">
				...
				<div class="elementor-template-library-favorite">
					...
					<label for="elementor-template-library-template-{{ template_id }}-favorite-input" class="elementor-template-library-template-favorite-label">
						...
						<span class="elementor-screen-only"><?php echo esc_html__( 'Favorite', 'aihub-core' ); ?></span>
					</label>
				</div>
			</div>
		</script>
		<script type="text/template" id="tmpl-elementor-template-library-get-pro-button-hub">
			<a class="elementor-template-library-template-action elementor-button elementor-go-pro" href="https://hubcollection.liquid-themes.com" target="_blank">
				...
				<span class="elementor-button-title"><?php echo __( 'Go Pro', 'aihub-core' ); ?></span>
			</a>
		</script>
		<script type="text/template" id="tmpl-elementor-pro-template-library-activate-license-button-hub">
			<a class="elementor-template-library-template-action elementor-button elementor-go-pro" href="#" target="_blank">
				...
				<span class="elementor-button-title"><?php _e( 'Activate License', 'aihub-core' ); ?></span>
			</a>
		</script>
		<?php
	}
