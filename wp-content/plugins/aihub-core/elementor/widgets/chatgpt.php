...
class LQD_CHATGPT extends Widget_Base {

	public function __construct($data = [], $args = null) {
		parent::__construct($data, $args);

        wp_register_script( 'lqd-chatgpt',
        	get_template_directory_uri() . '/liquid/assets/vendors/ai/widget-chatgpt.js',
        	[ 'jquery' ],
            null
        );

        wp_register_style( 'lqd-chatgpt',
        	get_template_directory_uri() . '/liquid/assets/vendors/ai/widget-chatgpt.css',
        	[],
            null
        );
	}
	...
	public function get_title() {
		return __( 'Liquid ChatGPT', 'aihub-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'request_limit',
			[
				'label' => esc_html__( 'Message limit', 'aihub-core' ),
		...
		$this->add_control(
			'container_height',
			[
				'label' => esc_html__( 'Container Max Height', 'textdomain' ),
		...
		$this->add_control(
			'input_position',
			[
				'label' => esc_html__( 'Input position', 'aihub-core' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'How can I assist today?', 'aihub-core' ),
				'label_block' => true,
				'ai' => [
					'active' => false
				]
...
\Elementor\Plugin::instance()->widgets_manager->register( new LQD_CHATGPT() );